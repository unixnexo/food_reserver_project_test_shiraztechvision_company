...
// //
// // LAYOUT PURPOSE (for AI agents / future readers):
// // Shared shell for all /admin/** pages — simple nav bar linking to each
// // admin section. Access control (PARENT users can't reach /admin/**) is
// // already enforced by middleware.ts; this layout does not re-check auth.
