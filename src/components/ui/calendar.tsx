  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          "flex h-(--cell-size) w-full items-center justify-center px-(--cell-size) text-base",
...
function CalendarDayButton({
  ...
  return (
    ...
    >
      {children}
      {!!foodCount && (
        <span className="text-[11px] font-bold leading-none text-[#183D2B] group-data-[selected-single=true]/day:text-white">
          {foodCount}
        </span>
      )}
    </Button>
